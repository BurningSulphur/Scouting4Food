...
public partial class Plugin : BaseUnityPlugin
{
    ...
    {//                                                                English                          Français                      Italiano                      Deutsch                       Español  (España)             Español (LatAm)               Português (BR)                Русский                       Українська                    简体中文                       繁體中文                        日本語                         한국어                              Polski                                 Türkçe
        LocalizedText.mainTable["NAME_CHICKEN DRUMSTICK"] =           ["Chicken Drumstick"              ,"Chicken Drumstick"         ,"Chicken Drumstick"          ,"Chicken Drumstick"          ,"Chicken Drumstick"          ,"Chicken Drumstick"          ,"Chicken Drumstick"          ,"Chicken Drumstick"          ,"Chicken Drumstick"          ,"Chicken Drumstick"          ,"Chicken Drumstick"          ,"Chicken Drumstick"          ,"Chicken Drumstick"              ,"OGROMNE UDKO Z KURCZAKA"               ,"Chicken Drumstick"                  ];
